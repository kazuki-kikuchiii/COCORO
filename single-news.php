<?php get_header( 'noLoading' ); ?>
        <main>
            ...
            <div class="breadcrumb">
                <div class="wrapper">
                    <a href="<?php echo esc_url( home_url()); ?>" class="breadcrumb__home">ホーム</a>&nbsp>&nbsp<a href="<?php echo esc_url( home_url( '/news' ) ); ?>" class="breadcrumb__news">ニュース一覧</a>&nbsp>&nbsp<?php the_title(); ?>
                </div>
            </div>
            <!-- /.breadcrumb -->

            <section class="section-wrapper_r inner">
                                ...
                                <a href="<?php the_permalink(); ?>" class="news-aside__pickup-link">
                                    <div class="news-aside__pickup-link--image">
                                        <?php if(has_post_thumbnail()) : ?>
                                            <?php the_post_thumbnail('thumbnail'); ?>
                                        <?php else : ?>
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/thumbnail-cocoro-def.png" alt="WEB制作フリーランス、ココロのデフォルト画像" />
                                            </a>
                                        <?php endif;?>
                                    </div>
